"""
Basis-Klasse für E-Mail-Dialoge.
Enthält gemeinsame Funktionalität für CustomEmailDialog und BulkEmailDialog.
"""
import os
...
from PySide6.QtWidgets import (
    ...
    QMessageBox, QFileDialog, QFormLayout, QComboBox, QCheckBox, QScrollArea, QWidget,
    QApplication
)
...
class BaseEmailDialog(QDialog):
    """Basis-Dialog für E-Mail-Versand-Funktionalität."""
    ...
    def _setup_ui(self):
        ...
        # Empfänger-Gruppe - Titel wird in abgeleiteten Klassen angepasst
        self.recipients_group = QGroupBox("Empfänger")
        recipients_layout = QVBoxLayout(self.recipients_group)
        ...
        # In Unterklassen kann hier die Kontextmenü-Funktionalität hinzugefügt werden

        recipients_layout.addLayout(selection_layout)
        recipients_layout.addWidget(self.person_list)

        layout.addWidget(self.recipients_group)
    ...
    def send_email(self):
        """Sendet die E-Mail. Wird in abgeleiteten Klassen überschrieben."""
        # Basisimplementierung - in Unterklassen überschreiben
