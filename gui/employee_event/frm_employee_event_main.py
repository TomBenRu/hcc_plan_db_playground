...
from PySide6.QtCore import Qt, Signal, QTimer, QDate, QLocale
from PySide6.QtGui import QFont
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QGridLayout, QFormLayout,
    QLabel, QTableWidget, QTableWidgetItem, QHeaderView, 
    QCalendarWidget, QPushButton, QComboBox, QLineEdit, QGroupBox,
    QFrame, QSplitter, QAbstractItemView, QMessageBox, QCheckBox
)
...
class FrmEmployeeEventMain(QWidget):
    ...
    def _setup_list_view(self):
        ...
        self.view_layout.addWidget(self.table_events)
    
    def _setup_calendar_view(self):
        """Erstellt die Kalender-Ansicht."""
        # TODO: Implementierung der Kalender-Ansicht in separatem Widget
        # Placeholder für jetzt
        self.calendar_widget = QWidget()
        calendar_layout = QVBoxLayout(self.calendar_widget)
        
        # QCalendarWidget für Basis-Funktionalität
        ...
        # Event-Details-Panel für Kalender
        self.calendar_events_panel = QWidget()
        calendar_events_panel_layout = QVBoxLayout(self.calendar_events_panel)
        
        self.lb_calendar_date = QLabel(self.tr("Select a date to view events"))
        self.lb_calendar_date.setStyleSheet("font-weight: bold; color: #006d6d;")
        calendar_events_panel_layout.addWidget(self.lb_calendar_date)
        ...
        calendar_events_panel_layout.addWidget(self.list_calendar_events)
        
        calendar_layout.addWidget(self.calendar_events_panel)
        
        self.view_layout.addWidget(self.calendar_widget)
    ...
    def _switch_view(self, view_mode: str):
        ...
        if view_mode == "list":
            # Liste aktivieren, Kalender verstecken
            self.table_events.show()
            self.calendar_widget.hide()
            ...
            # Kalender aktivieren, Liste verstecken
            self.table_events.hide()
