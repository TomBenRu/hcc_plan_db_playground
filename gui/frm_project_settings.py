...
class DlgSettingsProject(QDialog):
    def __init__(self, parent: QWidget, project_id: UUID):
        ...
        self.layout_group_project_data.addWidget(self.lb_admin, 1, 0)
        self.layout_group_project_data.addWidget(self.cb_admin, 1, 1)
        self.layout_group_project_data.addWidget(self.bt_admin, 1, 2)
        self.layout_group_project_data.addWidget(self.lb_time_of_days, 2, 0)
        self.layout_group_project_data.addWidget(self.bt_time_of_day, 2, 2)
        self.layout_group_project_data.addWidget(self.lb_time_of_day_enums, 3, 0)
        self.layout_group_project_data.addWidget(self.cb_time_of_day_enums, 3, 1)
        self.layout_group_project_data.addWidget(self.bt_time_of_day_enums, 3, 2)
        self.layout_group_project_data.addWidget(self.lb_skills, 4, 0)
        self.layout_group_project_data.addWidget(self.bt_skills, 4, 2)
        self.layout_group_project_data.addWidget(self.lb_cast_rules, 5, 0)
        self.layout_group_project_data.addWidget(self.bt_cast_rules, 5, 2)
    ...
    def edit_excel_export_settings(self):
        ...
        if dlg.exec():
            self.controller.execute(
                project_commands.NewExcelExportSettings(
                    self.project.id,
