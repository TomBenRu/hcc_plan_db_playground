...
avail_day__event: dict[int, str] = {
    1: "QPushButton "
       "{background-color: #cae4f4; border-radius: 5px;}"
       "QPushButton::checked "
    ...
    2: "QPushButton "
       "{background-color: #fff4d6; border-radius: 5px;}"
       "QPushButton::checked "
    ...
    3: "QPushButton "
       "{background-color: #daa4c9; border-radius: 5px;}"
       "QPushButton::checked "
    ...
    4: "QPushButton "
       "{background-color: #a9a9a9; border-radius: 5px;}"
       "QPushButton::checked "
