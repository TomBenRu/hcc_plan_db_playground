...
all_events_plan_period: list[schemas.EventShow] = []
handler_event_for_plan_period_cast.signal_new_event.connect(lambda e: all_events_plan_period.append(e))
...
def optimize_plan_period_cast(plan_period_id: UUID, nr_random_appointments: int):
    ...
    initial_plan_period_cast = generate_initial_plan_period_cast(plan_period_id, all_events_plan_period)
