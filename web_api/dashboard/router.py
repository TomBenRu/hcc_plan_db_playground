...
_ROLE_SECTIONS: dict[WebUserRole, dict] = {
    ...
    WebUserRole.dispatcher: {
        "tiles": [
            ...
            {
                "title": "Notfall-Kreise",
                "desc": "Empfänger bei kurzfristigen Notfall-Absagen pro Arbeitsort eingrenzen",
                "url": "/dispatcher/emergency-notification-circles",
    ...
    WebUserRole.admin: {
        "tiles": [
            ...
            {
                "title": "Teams & Zuordnungen",
                "desc": "Struktur, Standorte und Mitgliedschaften pflegen",
                "url": "/admin/teams",
    ...
    WebUserRole.viewer: {
        "tiles": [
            {
                "title": "Pläne aller Teams",
                "desc": "Einsatzpläne projektweit einsehen (Read-only)",
                "url": "/viewer/plan",
