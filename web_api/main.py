...
from web_api.dispatcher.emergency_notification_circles.router import router as emergency_notification_circles_router
...
app.include_router(emergency_notification_circles_router)
